...
; OUT_DIR='/home/sunshine/repos/magnetic_modeling_codes/example/vmf_analysis/02ambiguity_hmi/repro'
files=find_file(OUT_DIR+'/cmd_lat.sav',count=count)
;;; REMOVE THIS FILE WHEN RECALCULATING DATA !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
if (count eq 0) then begin
  ...
  save,cmd1,latitude,filename=OUT_DIR+'/cmd_lat.sav'
endif else begin
  restore,OUT_DIR+'/cmd_lat.sav',/ver
endelse
...
save,mapbx,mapby,mapbz,filename=OUT_DIR+'/mapbxyz_m.sav'
wdef,1,1300,800
!p.background=255
mapbz.id='Heliographic Bxyz'
plot_map,mapbz,color=0,bcolor=0,charsize=2.0,dmax=800,dmin=-800
write_png,OUT_DIR+'/bz_m.png',tvrd()
loadct, 0
; Limit - Lower boundary of magnetic field to plot arrows; Scale -- arrows length; Skip -- step between arrows
plot_vmap,/over,mapbx,mapby,mapbz=mapbz,limit=180,scale=0.03,iskip=31,jskip=31,$
          v_color=255,axis_color=0,/Nolabels,v_thick=2.0,/Noaxis
!p.background=0
write_png,OUT_DIR+'/bxyz_m.png',tvrd()
