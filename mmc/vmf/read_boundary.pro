...
pro read_boundary, IN_DIR, amrvac_file, amrvac_file_nlfff
...
openw, lun, IN_DIR + '/level3_data/dxdy_cm.txt', /get_lun

; Write each line to the file
printf, lun, 'dx dy [for boundary conditions, cm]:'
printf, lun, strtrim(string(dx),2) + " " + strtrim(string(dy),2)
...
extract_and_update_amrvacpar_, amrvac_out_dir, amrvac_file, fmt_xmin1, fmt_xmin2, fmt_xmin3, fmt_xmax1, fmt_xmax2, fmt_xmax3, nx, ny
...
extract_and_update_amrvacpar_, amrvac_out_dir, amrvac_file_nlfff, fmt_xmin1, fmt_xmin2, fmt_xmin3, fmt_xmax1, fmt_xmax2, fmt_xmax3, nx1, nx2
